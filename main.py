...
SECRET_KEY = os.environ.get("SECRET_KEY", "nexasync-plm-secret-2025-aquarelle")

app = FastAPI(title="NexaSync Apparel PLM", description="Sample Lifecycle Tracking System")
    ...
    if os.environ.get("RENDER"):
        try:
            ...
            if count == 0:
                ...
                seed.reset_and_seed()
                print("==> NexaSync: Demo data seeded successfully on Render")
        except Exception as e:
            print(f"==> NexaSync: Auto-seed note: {e}")
...
@app.get("/health")
def health():
    return {"status": "ok", "app": "NexaSync PLM"}
